...
##
## tests for wifipasswords package
##
...
class TestRunner(unittest.TestCase):
    ...
    def test_save_wpa_supplicant_file_created(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            self.wifipw.save_wpa_supplicant(os.path.join(temp_dir,'wpa_supplicant.conf'),data,True,'GB')
    ...
    def test_get_single_password_raises_ValueError_for_unknown_network(self):
        with self.assertRaises(ValueError):
            self.wifipw.get_single_password('unknownssids')
