## separate copy of __main__ to produce a single exe build not for pypi distribution
## package using pyinstaller 
## adds an os.pause argument at the end of the cli function to pause the console if the exe is run directly.
## changes to __main__ should be brought down into this file before building exe.
